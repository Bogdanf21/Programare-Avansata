...
public class Main {
    ...
    public static void homeworkPlusBonus(String[] args) {
        ...
        while (counter < noOfArguments) {
            //Am mers pe premisa ca trebuie cate un spatiu intre fiecare litera, din acest motiv abordarea asta. Daca e scris un cuvant (m. mult de 1 litera), va fi luata in considerare doar prima litera
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = 0; j < p; j++) {// Asta e ce am gasit pe internet legat de random strings, am vazut ca implementarea din suportul de laborator e mai simpla dar am lasat asa.
